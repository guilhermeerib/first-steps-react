...
export function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-tertiary-container text-primary hover:opacity-80 focus:ring-primary',
    danger: 'bg-error text-white hover:opacity-90 focus:ring-error',
    ghost: 'bg-transparent text-primary hover:bg-tertiary-container focus:ring-primary',
  }
